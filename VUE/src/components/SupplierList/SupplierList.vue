...
import { selectItems, removeItem, fetchItems  } from '@/store/suppliers/selectors'
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      onClickEdit: ( id ) => {
        router.push({ name: 'SupplierEdit', params: { id } })
      },
      onClickProducts: (supplier_id) => {
        router.push({ name: 'ProductFiltered', params: { supplier_id } })
      }
    }
  },
}
